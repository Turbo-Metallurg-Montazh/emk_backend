...
public abstract class FindTendersPostDataSerializer {
    public static String jsonData(FindTendersPostEntity findTendersPostEntity) throws JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
        mapper.configure(SerializationFeature.FAIL_ON_EMPTY_BEANS, false);
        mapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);
        return mapper.writeValueAsString(findTendersPostEntity);
    }
}
